...
Defeat is here but it's highly conditional, meaning you'll see it randomly instead of frequently and sometimes just because you got hit really hard without blocking. If you have any followers on your side they will have to get knocked down too before you get taken advantage of. If you want to see yourself getting taken advantage of more often, try traveling without a follower. To guarantee it, under _Player as Victim_ set yourself to _Essential_ but I recommend against this option because as I understand it magnifies all of Defeat's bugs about tenfold. I would definitely reload the game after every Defeat scenario if you do this. And anyway, if a bandit is going to take advantage of you and steal your stuff, do you really think s/he would leave you alive to tell somebody about it? Muh immersion. If you don't want to be taken advantage of at all and prefer a quick, merciful death, disable the _Player as Victim_ section completely. This will still allow you to sublimate your fantasies harmlessly into Skyrim by tying people up and putting them in bags for later. Speaking of which, if you feel the need to defeat someone outside of combat, you can either sneak up behind them and press G, or mark them with G and try to knock them down with your fists. If you do this in the presence of others you _will_ get attacked with my settings. I encourage you to experiment with Defeat to adjust it to your liking, but keep in mind it's a very buggy mod that's been rewritten many times.

### Camera

I included the vastly inferior IFPV because I've got it defaulting to off so it doesn't muck with gameplay. From first person mode, you have to hit Numpad 0, then F to switch it on. It doesn't work at all when the partners are really close together (too much clipping) but it at least gives you a quick default to setting up your own POV view with Numpad 3. Relax and enjoy on it. Honestly I use this more to take a quick look down at my own huge bouncy boobs. Another reason I have this is so _Alternate Conversation Camera_ can be used in conjunction (so long as IFPV is disabled) because I can't resist the chance to at least see my own carefully crafted character in gameplay-related closeups.
...
For the bodies I used CBBE 3BBB. I've been hearing good things about SMP improvements in my other modding Discords so it might be possible to leave SMP on the player only for the majority of the game. If you get in a heavy combat scenario, though, and your belly stretches to infinity... well SMP has crashed and you'll have to exit the game to continue. I haven't encountered this myself, but in previous builds I would get around it by using SMP only during sexytime. You can also turn SMP on various NPC's with numpads 5-8 but it will reset their equipment to default. So do it before you start a scene or it'll get a lot more modest.  For NPCs, it's your traditional WICO, Pandorables, Bijin combo, only I added a few of Eeekie's (especially that crafty Cicero) on top. This may introduce the possibiility of BFBs (brown face bugs) so please tell me if you see any of those so I can patch them out. Finally, everyone wearing vanilla clothes or armor has been outfitted with much sexier gear. It's not as in-your-face as my previous build, just so I could have a little variety, but the list is still decidedly unwelcome among mixed company. Play it alone! If you want to hide your shame, or simply muh immersion at the idea of Mjoll walking around with all four cheeks on display, stop by NSFW and I'll tell you how to get everyone to cover up their meat. The armor from the worldspace mods like Falskaar has been left unchanged.

### Poser Mods

I submit to you that posing is better suited for a more full-featured adult modlist like erri120's _Lotus_ or a screenshot-focused one like Geez's _Cupid_, but if you must add one, Nemesis isn't up to the task of handling that many animations. I recommend you switch to FNIS. Disable _Nemesis Behavior Engine_, _The Ultimate Dodge Mod_, _The Ultimate Dodge Mod Reanimated_, and _Nemesis Output_. Install _FNIS_ and move it just below _SexLabFramework_ in the left pane. Activate it and move the ESP just below _SkyUI_SE.esp_ in the right pane. Install your poser mod. A link to FNIS is already left over, but when you run it be sure to tick _Gender-Specific Animations_ and _Ultimate Combat_. If you want a dodge of some kind you'll have to install _TK Dodge_ before you do this.
